...
function Header(){
    return(<div>
           <h1>March Madness!!!</h1>
           <h4>This website lists the teams that are competing in the March Madness Tournament this year.</h4>
           </div>);
}
...
class Team extends React.Component < {school: string, name: string, city: string, state: string} > {
    render() {
        ...
        return(
            <div>
                <h2>{singleTeam.school} {singleTeam.name}</h2>
                <h5>{singleTeam.city}, {singleTeam.state}</h5> 
            </div>
        );
    }
}
